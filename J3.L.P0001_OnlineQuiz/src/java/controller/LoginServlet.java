...
public class LoginServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            // if account is exist in db -> get this account information
            if (accountDAO.isExistAccount(username, password)) {
                ...
                request.getRequestDispatcher("view/home-page-login.jsp").forward(request, response);
            }
